...
//       data.year===2021 ?(this.state.item1.push(data)):""
//     ))
//     const data21 = e.target.value;
//     // const data = data && data.map((item, key) =>{
//     //     console.log(item)
//     // })
//     // this.state.data &&

...
//                 <button  onClick={() => ultimateSelection(0)} >
//                 Present Developnent
//                 </button>
//               </Tab>
//               <Tab onClick={() => ultimateSelection(2)} style={{ background: "#f4faa0", borderRadius: "5px" }}>
...
//               <Tabs defaultIndex={1}>
//                 <TabList>
//                   <Tab onClick={() => ultimateSelection(1)} style={{ background: "#f5e5f8", borderRadius: "5px" }}>
//                     Readiness
//                   </Tab>
//                   <Tab onClick={() => ultimateSelection(0)} style={{ background: "#f2f9a0", borderRadius: "5px" }}>
//                     Availability
//                   </Tab>
//                 </TabList>
//                 <TabPanel></TabPanel>
...
//               <Tabs>
//                 <TabList>
//                   <Tab onClick={() => ultimateSelection(2)} style={{ background: "#f5e5f8", borderRadius: "5px" }}>
//                     Capacity Building
//                   </Tab>
//                   <Tab onClick={() => ultimateSelection(3)} style={{ background: "#f2f9a0", borderRadius: "5px" }}>
...
//         </div>
//         {/* <p style={{ color: "green" }}>
//           <Accordion defaultIndex={[0]} allowToggle style={{ width: "700px" }}>
